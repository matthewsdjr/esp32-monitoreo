...
// ============================================================================
// Generado por tools/scripts/generar-ca.sh contra supabase.co
//
...
static const char CA_RAICES[] =
    ...
    // ancla principal: valida la cadena actual
    // expira: Jun  4 11:04:38 2035 GMT
    "-----BEGIN CERTIFICATE-----\n"
    ...
    // raíz servida en la cadena (respaldo)
    // expira: Sep  2 23:59:59 2032 GMT
    "-----BEGIN CERTIFICATE-----\n"
